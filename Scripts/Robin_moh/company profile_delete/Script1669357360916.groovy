...
WebUI.click(findTestObject('Page_Companies Profiles/span_Delete'))

WebUI.verifyElementVisible(findTestObject('Page_Companies Profiles/div_ConfirmationAre you sureYesNo'))

WebUI.click(findTestObject('Page_Companies Profiles/span_Yes'))
